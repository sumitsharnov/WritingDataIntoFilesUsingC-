...
namespace Assignment_Information_Encoding_4
{
    class SpreadSheet
    {
        public void creatingSpreadSheet()
        {
            //Creating Spreadsheet document

            using (SpreadsheetDocument spreadsheetDocument =
        SpreadsheetDocument.Create(@"C:\\Users\\Public\\Music\\info.xlsx", SpreadsheetDocumentType.Workbook))
            {
                ...
                */
                ...
                InsertText("C:\\Users\\Public\\Music\\info.xlsx", "Hello, my name is Sumit");
